% RL 17: Rescorla-Wagner (RW) 2 learning rates (LR) + 2 forgetting rates (FR) + error-dependent decision noise model 
% 
...
% RW 2LR + 2FR + error-depend decision noise model parameters
...
params.gamma = 0.01;
% 6) initial inverse temperature (range > 0)
params.beta_0 = 4;
% 7) inverse temperature update rate (range between 0 and 1)
params.alpha_d = 0.5;
...
for t = 1:T
    ...
    beta(t+1) = max(beta(t+1), 0.01); % keep it above 0.01
