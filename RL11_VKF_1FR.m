% RL 11: volatile Kalman filter + 1 forgetting rate (FR) model 
% 
...
params.lambda = 0.2;
% 4) forgetting rate (range between 0 and 1)
params.psi = 0.25;
...
for t = 1:T
    ...
    mean(unchose_opt_ls, t+1) = (1-params.psi)*(mean(unchose_opt_ls, t));
