% AInf 10: 2 learning rates (LR) + 1 forgetting rate (FR) + error-dependent decision noise model 
% 
...
% AInf 2LR + 1FR + error-dependent decision noise model parameters
...
params.beta_0 = 6;
% 6) inverse temperature update rate (range > 0)
params.alpha_d = 2;
