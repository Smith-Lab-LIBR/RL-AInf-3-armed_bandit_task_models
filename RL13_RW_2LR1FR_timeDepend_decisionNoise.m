% RL 13: Rescorla-Wagner (RW) 2 learning rates (LR) + 1 forgetting rate (FR) + time-dependent decision noise model 
% 
...
% RW 2LR + 1FR + time-depend decision noise model parameters
...
% 3) forgetting rate (range between 0 and 1)
params.psi = 0.25;
% 4) information bonus (any real value)
params.gamma = 0.01;
% 5) upward shift in overall inverse temperature (range > 0)
params.beta_shift = 6;
% 6) steepness of change in inverse temperature over time (any real value)
