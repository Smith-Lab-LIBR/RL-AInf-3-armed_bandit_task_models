% RL 12: Rescorla-Wagner (RW) 1 learning rate (LR) + 1 forgetting rate (FR) + time-dependent decision noise model 
% 
...
% RW 1LR + 1FR + time-depend decision noise model parameters
...
params.gamma = 0.01;
% 4) upward shift in overall inverse temperature (range > 0)
params.beta_shift = 5;
% 5) steepness of change in inverse temperature over time (any real value)
