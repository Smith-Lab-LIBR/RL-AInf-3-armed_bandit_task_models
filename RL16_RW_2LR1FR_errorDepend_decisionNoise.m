% RL 16: Rescorla-Wagner (RW) 2 learning rates (LR) + 1 forgetting rate (FR) + error-dependent decision noise model 
% 
...
% RW 2LR + 1FR + error-depend decision noise model parameters
...
params.gamma = 0.01;
% 5) initial inverse temperature (range > 0)
params.beta_0 = 4;
% 6) inverse temperature update rate (range between 0 and 1)
params.alpha_d = 0.5;
